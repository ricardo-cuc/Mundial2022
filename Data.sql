...
------------------------------DELETE TABLA APUESTAS USUARIOS Y RE CREA-------------------------------
CREATE TABLE APUESTAS_USUARIOS
(
NRO_APUETAS INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
NRO_PARTIDO INT NOT NULL,
U_CODIGO CHAR (5) NOT NULL,
A_TIPO_RESULTADO INT NOT NULL,
A_RESULTADO_E1 INT NOT NULL,
A_PUNTOS_CANJEADOS INT NOT NULL,
